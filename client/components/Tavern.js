...
const Pixi = () => {
    return(<div>
                <h2>Tavern Minis</h2>
                <div>An online store for purchasing character minis, monster minis, paints, dice and various accessories. 
                ...
                <Iframe url="https://www.youtube.com/embed/cMEuC60_0kA"
                    ...
                    display="initial"
                    position="relative"/>
                <a href="https://tavern-minis.herokuapp.com/home">Try it out!</a>
           </div>)
}
